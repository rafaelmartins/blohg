...
class PageTestCase(unittest.TestCase):
    ...
    def _get_model(self, content):
        ...
        commands.commit(self.ui, self.repo, file_path, message='foo',
                        addremove=True)
        return self.model(self.repo, self.repo[None]['content/stub.rst'],
                          'content', '.rst', 2)
...
"""
        ...
        self.assertTrue(obj.date == 1234567890)
        self.assertTrue(obj.datetime == datetime(2009, 2, 13, 23, 31, 30))
...
"""
        obj = self._get_model(content)
        self.assertTrue(obj.mdate == 1234567891)
        self.assertTrue(obj.mdatetime == datetime(2009, 2, 13, 23, 31, 31))
